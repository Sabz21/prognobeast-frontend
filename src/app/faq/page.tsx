...
const faqItems = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Oui. Votre abonnement est à durée indéterminée. Si vous souhaitez l'annuler, veuillez contacter Prognobeast sur Telegram, Insta ou Tiktok afin de l'annuler.",
      },
      {
